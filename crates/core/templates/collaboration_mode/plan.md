...
- Only read-only tools are available: read_file, list_dir, list, read_memory, memory_search, read_pdf, web_fetch, web_search, security_audit.
...
## Finalization
Present your final plan wrapped in `<proposed_plan>` tags:
